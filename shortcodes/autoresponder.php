...
add_shortcode('autoresponder', 'vue_component_autoresponder_shortcode');
function vue_component_autoresponder_shortcode($atts, $content, $shortcode) {
	global $wpdb;
	$listId = ($shortcode == 'autoresponder') ? 2 : 1;
